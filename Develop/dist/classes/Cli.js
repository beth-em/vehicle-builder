...
class Cli {
    ...
    findVehicleToTow(truck) {
        inquirer
            ...
            console.log(`${truck.make} ${truck.model} is now towing ${vehicleToTow.make} ${vehicleToTow.model},`);
            this.performActions();
        });
    }
        ...
        inquirer
            ...
            for (let i = 0; i < this.vehicles.length; i++) {
                if (this.vehicles[i].vin === this.selectedVehicleVin) {
                    ...
                    if (answers.action === 'Accelerate 5 MPH')
                        selectedVehicle.accelerate(5);
                    // find the selected vehicle and accelerate it by 5 MPH
                    if (answers.action === 'Decelerate 5 MPH')
                        selectedVehicle.decelerate(5);
                    // find the selected vehicle and decelerate it by 5 MPH
                    if (answers.action === 'Stop vehicle')
                        selectedVehicle.stop();
                    // find the selected vehicle and stop it
                    if (answers.action === 'Turn right')
                        selectedVehicle.turn("right");
                    // find the selected vehicle and turn it right
                    if (answers.action === 'Turn left')
                        selectedVehicle.turn("left");
                    // find the selected vehicle and turn it left
                    if (answers.action === 'Reverse')
